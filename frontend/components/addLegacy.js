      ...
      <>
        {isSuccess ? (
          <>
            ...
            <a
              href={`https://blockscout.scroll.io/tx/${receipt?.transactionHash}`}
            >
              <button className="text-lg font-semibold bg-gray-200 py-3 px-8 self-start mx-3 border-none rounded-full text-white">
                {/* View Txn on Etherscan */}
                View Txn on Scroll explorer
              </button>
            </a>
            <button
